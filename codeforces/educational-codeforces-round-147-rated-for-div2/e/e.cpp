...
/**
 * problem E (5/6)
 * codeforces, educational-codeforces-round-147-rated-for-div2
 * author: @shamir0xe
...
int dfs(int u, int &idx, string &str, priority_queue<pii> &pq) {
    // trace(u _ idx);
    idx++;
    int res = 0;
    while (str[idx] != ')') {
        res += dfs(++node_cnt, idx, str, pq);
    }
    idx++;
    pq.push({res, u});
    res++;
