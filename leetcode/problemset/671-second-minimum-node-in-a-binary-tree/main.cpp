 ...
 * problem 671-second-minimum-node-in-a-binary-tree (1/1)
 * leetcode, problemset
 * author: @shamir0xe
...
class Solution {
  ...
  public:
    int findSecondMinimumValue(TreeNode *root) {
        if (root->left != nullptr) findSecondMinimumValue(root->left);
        if (root->right != nullptr) findSecondMinimumValue(root->right);
