...
class BearSong {
  public:
    int countRareNotes(std::vector<int> notes) {
    	sort(all(notes));
    	int cnt = 0;
    	for (int i: range(sz(notes))) {
    		int bef = i - 1 < 0 || notes[i] != notes[i - 1];
    		int next = i + 1 >= sz(notes) || notes[i] != notes[i + 1];
    		cnt += bef && next;
    	}
    	return cnt;
    }
...
int run_test_case(int casenum__) {
    ...
    case 0: {
        ...
        int received__ = BearSong().countRareNotes(
            vector<int>(notes, notes + (sizeof notes / sizeof notes[0])));
        return verify_case(casenum__, expected__, received__,
                           clock() - start__);
    }
    case 1: {
        int notes[] = {8, 8, 7, 6, 7, 3, 5, 10, 9, 3};
        int expected__ = 4;
    ...
    case 4: {
        int notes[] = {1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000,
        ...
        /*      case 5: {
                                ...
                                std::clock_t start__      = std::clock();
                                int received__            =
           BearSong().countRareNotes(vector <int>(notes, notes + (sizeof notes /
           sizeof notes[0]))); return verify_case(casenum__, expected__,
